...
public:
    ...
    // getters
    inline uint_fast8_t getXDim() { return x_dim; }
    inline uint_fast8_t getUDim() { return u_dim; }
    inline uint_fast8_t getZDim(const uint_fast8_t iz = 0) { return z_dim[iz]; }
    inline uint_fast8_t getZNumber() { return z_number; }
};
#ifndef ARDUINO
#include "Ekf.cpp"
#endif
