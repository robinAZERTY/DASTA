...
void Dasta::configSensorPreProcessing()
{
    ...
    // sensors.acc_bias_co.alloc(3);
    // sensors.gyro_bias_co.alloc(3);
    // sensors.mag_bias_co.alloc(3);

    // sensors.acc_scale_co.alloc(3, 3);
    // sensors.gyro_scale_co.alloc(3, 3);
    // sensors.mag_scale_co.alloc(3, 3);


    sensors.acc_bias_co.fill(0);
    sensors.gyro_bias_co.fill(0);
    sensors.mag_bias_co.fill(0);

    sensors.acc_scale_co.set_eye();
    sensors.gyro_scale_co.set_eye();
    sensors.mag_scale_co.set_eye();
    ...
    sensors.mag.data = new data_type[3];
}