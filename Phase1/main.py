...
# cv2.resizeWindow("frame", 300, 800)
...
# cv2.createTrackbar("X", "frame", 0, 100, lambda x: angularVel.__setitem__(0, rxmin + (rxmax - rxmin) * x / 100))
# cv2.createTrackbar("Y", "frame", 0, 100, lambda x: angularVel.__setitem__(1, rymin + (rymax - rymin) * x / 100))
# cv2.createTrackbar("Z", "frame", 0, 100, lambda x: angularVel.__setitem__(2, rzmin + (rzmax - rzmin) * x / 100))
# # but with default values to 50
# cv2.setTrackbarPos("X", "frame", 50)
# cv2.setTrackbarPos("Y", "frame", 50)
# cv2.setTrackbarPos("Z", "frame", 50)
...
# cv2.createTrackbar("kpX", "frame", 0, 100, lambda x: pidX.__setitem__(0, minkp + (maxkp - minkp) * x / 100))
# cv2.createTrackbar("kiX", "frame", 0, 100, lambda x: pidX.__setitem__(1, minki + (maxki - minki) * x / 100))
# cv2.createTrackbar("kdX", "frame", 0, 100, lambda x:  pidX.__setitem__(2, minkd + (maxkd - minkd) * x / 100))
# cv2.createTrackbar("timeConstDerFilterX", "frame", 0, 100, lambda x: pidX.__setitem__(3, mintimeConstDerFilter + (maxtimeConstDerFilter - mintimeConstDerFilter) * x / 100))
# cv2.createTrackbar("maxIntegralX", "frame", 0, 100, lambda x: pidX.__setitem__(4, minmaxIntegral + (maxmaxIntegral - minmaxIntegral) * x / 100))
# cv2.createTrackbar("minX", "frame", 0, 100, lambda x: pidX.__setitem__(5, minmin + (maxmin - minmin) * x / 100))
# cv2.createTrackbar("maxX", "frame", 0, 100, lambda x: pidX.__setitem__(6, minmax + (maxmax - minmax) * x / 100))

# cv2.createTrackbar("kpY", "frame", 0, 100, lambda x: pidY.__setitem__(0, minkp + (maxkp - minkp) * x / 100))
# cv2.createTrackbar("kiY", "frame", 0, 100, lambda x: pidY.__setitem__(1, minki + (maxki - minki) * x / 100))
# cv2.createTrackbar("kdY", "frame", 0, 100, lambda x: pidY.__setitem__(2, minkd + (maxkd - minkd) * x / 100))
# cv2.createTrackbar("timeConstDerFilterY", "frame", 0, 100, lambda x: pidY.__setitem__(3, mintimeConstDerFilter + (maxtimeConstDerFilter - mintimeConstDerFilter) * x / 100))
# cv2.createTrackbar("maxIntegralY", "frame", 0, 100, lambda x: pidY.__setitem__(4, minmaxIntegral + (maxmaxIntegral - minmaxIntegral) * x / 100))
# cv2.createTrackbar("minY", "frame", 0, 100, lambda x: pidY.__setitem__(5, minmin + (maxmin - minmin) * x / 100))
# cv2.createTrackbar("maxY", "frame", 0, 100, lambda x: pidY.__setitem__(6, minmax + (maxmax - minmax) * x / 100))

# cv2.createTrackbar("kpZ", "frame", 0, 100, lambda x: pidZ.__setitem__(0, minkp + (maxkp - minkp) * x / 100))
# cv2.createTrackbar("kiZ", "frame", 0, 100, lambda x: pidZ.__setitem__(1, minki + (maxki - minki) * x / 100))
# cv2.createTrackbar("kdZ", "frame", 0, 100, lambda x: pidZ.__setitem__(2, minkd + (maxkd - minkd) * x / 100))
# cv2.createTrackbar("timeConstDerFilterZ", "frame", 0, 100, lambda x: pidZ.__setitem__(3, mintimeConstDerFilter + (maxtimeConstDerFilter - mintimeConstDerFilter) * x / 100))
# cv2.createTrackbar("maxIntegralZ", "frame", 0, 100, lambda x: pidZ.__setitem__(4, minmaxIntegral + (maxmaxIntegral - minmaxIntegral) * x / 100))
# cv2.createTrackbar("minZ", "frame", 0, 100, lambda x: pidZ.__setitem__(5, minmin + (maxmin - minmin) * x / 100))
# cv2.createTrackbar("maxZ", "frame", 0, 100, lambda x: pidZ.__setitem__(6, minmax + (maxmax - minmax) * x / 100))
...
#     # time.sleep(1)
#     # bluetoothTransmission.data_to_send.append({"user_event": 7, "send_stream_delay": 75}) #ENABLE_SENSOR_STREAM
#     # time.sleep(3)
#     # bluetoothTransmission.data_to_send.append({"user_event": 3}) #START_STREAM

#     '''
#     [[{'time': 40349, 'gyro': [-0.008522245101630688, 0.0, 0.004261122550815344], 'angular_vel_command': [0.0, 0.0, 0.0], 'm1PWM': 1.9859528541564941, 'm2PWM': 1.9859528541564941, 'm3PWM': -5.957858562469482, 'm4PWM': 1.9859528541564941}]]
#     '''
#     while(True):
